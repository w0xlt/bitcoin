...
BOOST_AUTO_TEST_CASE(util_ParseParameters)
{
    ...
    testArgs.LockSettings([&](const common::Settings& s) {
        ...
        BOOST_CHECK(s.command_line_options.count("a") && s.command_line_options.count("b") && s.command_line_options.count("ccc")
                    && !s.command_line_options.count("f") && !s.command_line_options.count("d"));
...
BOOST_AUTO_TEST_CASE(util_ReadConfigStream)
{
    ...
    test_args.LockSettings([&](const common::Settings& s) {
        ...
        BOOST_CHECK(s.ro_config.at("").count("a"));
        BOOST_CHECK(s.ro_config.at("").count("b"));
        BOOST_CHECK(s.ro_config.at("").count("ccc"));
        BOOST_CHECK(s.ro_config.at("").count("d"));
        BOOST_CHECK(s.ro_config.at("").count("fff"));
        BOOST_CHECK(s.ro_config.at("").count("ggg"));
        BOOST_CHECK(s.ro_config.at("").count("h"));
        BOOST_CHECK(s.ro_config.at("").count("i"));
        BOOST_CHECK(s.ro_config.at("sec1").count("ccc"));
        BOOST_CHECK(s.ro_config.at("sec1").count("h"));
        BOOST_CHECK(s.ro_config.at("sec2").count("ccc"));
        BOOST_CHECK(s.ro_config.at("sec2").count("iii"));
    });
