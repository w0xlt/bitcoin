...
static std::vector<unsigned char> ParseHexTest(const char* psz)
{
...
BOOST_AUTO_TEST_CASE(rfc5869_test_vector_1)
{
    ...
    std::vector<unsigned char> ikm  = ParseHexTest("0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b"); // 22 bytes
    std::vector<unsigned char> salt = ParseHexTest("000102030405060708090a0b0c"); // 13 bytes
    std::vector<unsigned char> info = ParseHexTest("f0f1f2f3f4f5f6f7f8f9"); // 10 bytes
    size_t L = 42;

    std::vector<unsigned char> expected_prk = ParseHexTest("077709362c2e32df0ddc3f0dc47bba63"
                                                       "90b6c73bb50f9c3122ec844ad7c2b3e5");
    std::vector<unsigned char> expected_okm = ParseHexTest("3cb25f25faacd57a90434f64d0362f2a"
...
BOOST_AUTO_TEST_CASE(rfc5869_test_vector_2)
{
    ...
    std::vector<unsigned char> ikm = ParseHexTest(
    ...
    std::vector<unsigned char> salt = ParseHexTest(
    ...
    std::vector<unsigned char> info = ParseHexTest(
    ...
    std::vector<unsigned char> expected_prk = ParseHexTest(
        "06a6b88c5853361a06104c9ceb35b45c"
        "ef760014904671014a193f40c15fc244"
    );
    std::vector<unsigned char> expected_okm = ParseHexTest(
...
BOOST_AUTO_TEST_CASE(rfc5869_test_vector_3)
{
    ...
    std::vector<unsigned char> ikm  = ParseHexTest("0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b");
