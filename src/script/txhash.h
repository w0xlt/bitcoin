...
struct TxHashCache
{
    ...
    // Cache entries are scoped to a specific transaction context.
    bool context_initialized GUARDED_BY(mtx){false};
    const void* cached_tx_ref GUARDED_BY(mtx){nullptr};
