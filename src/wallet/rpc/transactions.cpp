    ...
    EXCLUSIVE_LOCKS_REQUIRED(wallet.cs_wallet)
{
    ...
    // Received
    const bool include_received_entries{!is_mixed_input || include_mixed_received || filter_label.has_value()};
...
RPCMethod listtransactions()
{
    return RPCMethod{
        ...
        "If a label name is provided, this will return only incoming transactions paying to addresses with the specified label.\n"
                ...
                "A transaction with both wallet-owned and non-wallet inputs is reported as a mixed entry with the wallet's net amount, \n"
                "because the wallet cannot attribute foreign outputs or fee share without additional metadata.\n",
                {
                    ...
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::OBJ, "", "", Cat(Cat<std::vector<RPCResult>>(
                        {
                            ...
                            {RPCResult::Type::STR, "category", "The transaction category.\n"
                                ...
                                "\"mixed\"                 Transactions spending both wallet-owned and non-wallet inputs. The amount is the wallet net amount.\n"
