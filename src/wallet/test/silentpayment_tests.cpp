...
BOOST_AUTO_TEST_CASE(silent_addresses)
{
    ...
    XOnlyPubKey senderTweakedPubKey = silentpayment::Sender::CreateSilentPaymentAddress(senderkey,recipientPubkey);

    CKey ckey = silentpayment::Recipient::CreateSilentPaymentAddress(recipientkey, senderPubkey);
