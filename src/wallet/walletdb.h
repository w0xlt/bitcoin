...
public:
    ...
    bool WriteDescriptorCodex32(const uint256& desc_id, const CKeyingMaterial& secret);
    bool WriteCryptedDescriptorCodex32(const uint256& desc_id, const std::vector<unsigned char>& crypted);
    bool EraseDescriptorCodex32(const uint256& desc_id);
