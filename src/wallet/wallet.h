...
static constexpr uint64_t KNOWN_WALLET_FLAGS =
    ...
    |   WALLET_FLAG_METADATA_ENCRYPTED;
...
static const std::map<WalletFlags, std::string> WALLET_FLAG_TO_STRING{
    ...
    {WALLET_FLAG_METADATA_ENCRYPTED, "metadata_encrypted"}
};
...
static const std::map<std::string, WalletFlags> STRING_TO_WALLET_FLAG{
    ...
    {WALLET_FLAG_TO_STRING.at(WALLET_FLAG_METADATA_ENCRYPTED), WALLET_FLAG_METADATA_ENCRYPTED}
};
...
public:
    ...
    bool WriteTransation(WalletBatch& batch, const CWalletTx& wtx);
    ...
    void ListEncryptedTransactions();
