...
private:
    ...
    bool VerifySilentPayment(const CTransaction& tx, std::vector<std::tuple<CKey, int32_t>>& rawTrKeys, const std::map<uint256, CPubKey>& tweakData) EXCLUSIVE_LOCKS_REQUIRED(cs_wallet);
