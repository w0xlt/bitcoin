...
XOnlyPubKey Sender::CreateSilentAddress(
...
CKey Recipient::CreateSilentAddress(const CKey& recipient_secret_key, const XOnlyPubKey& _sender_public_key)
{
    int return_val;
    ...
    CreateTweakedPubkey(ctx, sender_public_key, recipient_keypair);
