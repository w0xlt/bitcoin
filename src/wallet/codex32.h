...
//! Minimum and maximum BIP-93 seed payload size in bytes.
static constexpr size_t CODEX32_MIN_SEED_BYTES = 16;
static constexpr size_t CODEX32_MAX_SEED_BYTES = 64;
