...
bool WalletBatch::EraseDescriptorCodex32(const uint256& desc_id, const CExtPubKey& xpub)
{
    return EraseIC(std::make_pair(DBKeys::WALLETDESCRIPTORCODEX32, std::make_pair(desc_id, SerializeExtPubKey(xpub))));
}
