...
public:
    ...
    std::vector<std::pair<Wtxid, CTransactionRef>>& GetExtraTxnForCompact() override EXCLUSIVE_LOCKS_REQUIRED(g_msgproc_mutex);
...
std::vector<std::pair<Wtxid, CTransactionRef>>& PeerManagerImpl::GetExtraTxnForCompact()
{
