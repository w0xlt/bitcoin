...
std::tuple<CTxDestination,bool> DecodeDestination(const std::string& str, const CChainParams& params, std::string& error_str, std::vector<int>* error_locations)
{
...
std::tuple<CTxDestination,bool> DecodeDestinationIndicatingSP(const std::string& str, std::string& error_msg)
{
    return DecodeDestination(str, Params(), error_msg, nullptr);
}

std::tuple<CTxDestination,bool> DecodeDestinationIndicatingSP(const std::string& str)
{
    std::string error_msg;
    return DecodeDestination(str, Params(), error_msg, nullptr);
}
