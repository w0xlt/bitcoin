...
inline constexpr uint32_t ASYNC_PNB_PROBE_FLAG_OVERFLOW{2U};
...
static_assert(sizeof(AsyncPNBProbeEventRecord) == 232);
...
static_assert(sizeof(AsyncPNBProbeFileHeader) == 64);
