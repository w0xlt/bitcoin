...
public:
    ...
    bool getSilentTransactionFirstInputPubKey(const uint256& txhash, XOnlyPubKey& firstInputPubKey) override
    {
        return g_silentpaymentindex->FindSilentPayment(txhash, firstInputPubKey);
    }
