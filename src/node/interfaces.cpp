...
public:
    ...
    // TODO: submitSolution could potentially use the same
    // SubmitBlockStateCatcher path to provide richer error information,
    // but that would change its return semantics (currently returns true
    // for duplicates).
