...
class SilentTransactioTest(BitcoinTestFramework):
    ...
    def test_addressinfo(self):
        ...
        addr01 = sp_addr_info_01.getspaddress()

        addr01_info = sp_addr_info_01.getaddressinfo(addr01)
        assert_equal(addr01_info['silent_payment_identifier'], 0)

        for i in range(20):
            sp_addr_info_01.getspaddress(str(i))

        addr01 = sp_addr_info_01.getspaddress(str(21))
        addr01_info = sp_addr_info_01.getaddressinfo(addr01)
        ...
        addr01 = sp_addr_info_01.getspaddress(str(67))
        addr01_info = sp_addr_info_01.getaddressinfo(addr01)
    ...
    def test_sp_descriptor(self):
        ...
        assert_raises_rpc_error(-4, "Error: This wallet has no available keys", sp_wallet_02.getspaddress)
        ...
        sp_addr = sp_wallet_02.getspaddress()
    ...
    def test_big_transaction_multiple_wallets(self):
        ...
        recv_addr_09 = mw_05.getspaddress()
    ...
    def test_backup_sp_descriptor(self):
        ...
        receiver_sp_address = receiver_bk_01.getspaddress()
    ...
    def test_load_silent_wallet(self):
        ...
        sp_recv_addr = load_recipient_wallet_01.getspaddress()
    ...
    def test_self_sp_transfer(self):
        ...
        sp_recv_addr = self_sender_wallet_01.getspaddress()
    ...
    def test_scantxoutset(self):
        ...
        for amount in [2.75, 3.98, 2.30]:
            ...
            recv_addr_03 = recipient_wallet_03.getspaddress()
