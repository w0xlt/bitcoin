...
class TxHashFunctionalTest(BitcoinTestFramework):
    ...
    def test_empty_selector_covenant(self):
        ...
        self.log.info("  Failure: mismatched output value rejected")
    ...
    def test_output_only_covenant(self):
        ...
        assert_not_equal(fail_result, None)
        assert_equal(self.nodes[0].getbestblockhash(), tip_before)
        self.log.info("  Failure: wrong scriptPubKey rejected")
    ...
    def test_invalid_selector_rejection(self):
        ...
        assert_equal(self.nodes[0].getbestblockhash(), tip_before)
        self.log.info("  Failure: trailing-bytes selector rejected")
    ...
    def test_vault(self):
        ...
        assert_not_equal(fail_result, None)
        assert_equal(self.nodes[0].getbestblockhash(), tip_before)
        self.log.info("  Failure: diversion to attacker rejected")
    ...
    def test_congestion_control(self):
        ...
        assert_not_equal(fail_result, None)
        assert_equal(self.nodes[0].getbestblockhash(), tip_before)
        self.log.info("  Failure: 2-output mismatch rejected")
    ...
    def test_crowdfunding(self):
        ...
        assert_not_equal(fail_result, None)
        assert_equal(self.nodes[0].getbestblockhash(), tip_before)
        self.log.info("  Failure: wrong crowdfunding output rejected")
    ...
    def test_ln_channel_close(self):
        ...
        assert_not_equal(fail_result, None)
        assert_equal(self.nodes[0].getbestblockhash(), tip_before)
        self.log.info("  Failure: Alice's leaf + Bob's outputs rejected")
