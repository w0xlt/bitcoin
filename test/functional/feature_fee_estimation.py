...
class EstimateFeeTest(BitcoinTestFramework):
    ...
    def test_estimate_dat_is_flushed_periodically(self):
        ...
        self.restart_node(0, extra_args=self.nodes[0].extra_args + ["-persistmempool=0"])
        ...
        # The disabled-persistence shutdown leaves both snapshots stale relative
        # to the block generated above. Do not leak them into later sub-tests.
        mempool_dat.unlink()
        mempool_policy_dat.unlink()
        self.start_node(0)
