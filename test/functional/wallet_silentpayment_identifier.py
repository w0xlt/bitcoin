...
class SilentIdentifierTest(BitcoinTestFramework):
    ...
    def test_identifier(self):
        ...
        recv_addr_01 = recipient_wallet_01.getspaddress()
        recv_addr_02 = recipient_wallet_01.getspaddress(label01)

        label02 = self.random_string(8)
        recv_addr_03 = recipient_wallet_02.getspaddress()
        recv_addr_04 = recipient_wallet_02.getspaddress(label02)

        # generate a large index
        recipient_wallet_03.getspaddress()
        for _ in range(85):
            recipient_wallet_03.getspaddress(self.random_string(8))

        label03 = self.random_string(8)
        recv_addr_05 = recipient_wallet_03.getspaddress(label03)
